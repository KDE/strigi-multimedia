...
QString KAviPlugin::resolve_audio(uint16_t id) const
{
    switch (id) {
    case 0x00 : return i18n("Unknown wave format"); break;
    case 0x01 : return i18n("Wave (PCM)"); break;
    case 0x02 : return i18n("Wave (ADPCM)"); break;
    case 0x50 : return i18n("MPEG"); break;
    case 0x55 : return i18n("MP3"); break;
    case 0x92 : return i18n("AC3"); break;
    default : return i18n("unknown codec", "Unknown");
    }
...
bool KAviPlugin::readInfo( KFileMetaInfo& info, uint /*what*/)
{
    ...
    if (done_avih) {
        ...
        if (strlen(handler_vids) > 0)
            ...
            appendItem(group, "Video codec", i18n("unknown codec", "Unknown"));

        if (done_audio)
            appendItem(group, "Audio codec", resolve_audio(handler_audio));
        else
            appendItem(group, "Audio codec", i18n("no codec", "None"));
